# DevSecOps-Project
Smart Campus Web Platform — DevSecOps Pipeline

Secure Smart Campus Web Application with an automated DevSecOps pipeline using Jenkins, SonarQube, Trivy, OWASP Dependency-Check, and deployment to AWS EC2.
